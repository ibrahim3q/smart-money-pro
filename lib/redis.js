...
// الهدف: بناء دليل كمّي حقيقي على أي الأسهم "تنسجم" مع معاييرنا الحالية
// (RSI/MACD/EMA) وأيها لا، بدل الاعتماد على انطباع من عيّنة صغيرة. هذا
// تتبّع بحت — لا يؤثر على قرارات التنفيذ الحالية حتى نجمع بيانات كافية.
